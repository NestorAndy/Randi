...
print("Hola")
print("Mi nombre es Nestor Andy")
print("Calcular el promedio de temperaturas para cada ciudad y semana")
Ciudad = 0
for ciudad in temperaturas:
    ...
    for semana in ciudad:
        ...
        print(f"El promedio de la semana {no_semana} es: {promedio}°C")
    promedio_ciudad = calcular_promedio(suma_promedio, len(ciudad))
    print(f"El promedio mensual es: {promedio_ciudad}°C")